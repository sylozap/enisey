...
## Сравнение метрик LinearRegressor, DesicionTreeRegressor и XGBRegressor

| Модель                | RMSE | MAE  | R^2  |
|-----------------------|------|------|------|
| LinearRegressor       | 3.92 | 1.77 | 0.98 |
| DesicionTreeRegressor | 5.67 | 3.58 | 0.96 |
| XGBRegressor          | 5.09 | 3.19 | 0.96 |
